...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.legend.Legend at 0x10fe95d60>
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{unique1}\PY{p}{(}\PY{n}{S}\PY{p}{)}\PY{p}{:}
  \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Return True if there are no duplicate elements in sequence S.\PYZdq{}\PYZdq{}\PYZdq{}}
  \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{S}\PY{p}{)}\PY{p}{)}\PY{p}{:}
    \PY{k}{for} \PY{n}{k} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{j}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{S}\PY{p}{)}\PY{p}{)}\PY{p}{:}
      \PY{k}{if} \PY{n}{S}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{==} \PY{n}{S}\PY{p}{[}\PY{n}{k}\PY{p}{]}\PY{p}{:}
        \PY{k}{return} \PY{k+kc}{False}              \PY{c+c1}{\PYZsh{} found duplicate pair}
  \PY{k}{return} \PY{k+kc}{True}                     \PY{c+c1}{\PYZsh{} if we reach this, elements were unique}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{S1}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{19}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{12}\PY{p}{,}\PY{l+m+mi}{34}\PY{p}{]}
\PY{n}{S2}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{18}\PY{p}{,}\PY{l+m+mi}{23}\PY{p}{,}\PY{l+m+mi}{78}\PY{p}{,}\PY{l+m+mi}{23}\PY{p}{,}\PY{l+m+mi}{100}\PY{p}{]}

\PY{n+nb}{print}\PY{p}{(}\PY{n}{unique1}\PY{p}{(}\PY{n}{S1}\PY{p}{)}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{unique1}\PY{p}{(}\PY{n}{S2}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\KeywordTok{def}\NormalTok{ unique2(S):}
  \CommentTok{"""Return True if there are no duplicate elements in sequence S."""}
\NormalTok{  temp }\OperatorTok{=} \BuiltInTok{sorted}\NormalTok{(S)                }\CommentTok{\# create a sorted copy of S}
  \ControlFlowTok{for}\NormalTok{ j }\KeywordTok{in} \BuiltInTok{range}\NormalTok{(}\DecValTok{1}\NormalTok{, }\BuiltInTok{len}\NormalTok{(temp)):}
    \ControlFlowTok{if}\NormalTok{ temp[j}\OperatorTok{{-}}\DecValTok{1}\NormalTok{] }\OperatorTok{==}\NormalTok{ temp[j]:}
      \ControlFlowTok{return} \VariableTok{False}                \CommentTok{\# found duplicate pair}
  \ControlFlowTok{return} \VariableTok{True}                     \CommentTok{\# if we reach this, elements were unique}
\end{Highlighting}
\end{Shaded}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{unique2}\PY{p}{(}\PY{n}{S}\PY{p}{)}\PY{p}{:}
  \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Return True if there are no duplicate elements in sequence S.\PYZdq{}\PYZdq{}\PYZdq{}}
  \PY{n}{temp} \PY{o}{=} \PY{n+nb}{sorted}\PY{p}{(}\PY{n}{S}\PY{p}{)}                \PY{c+c1}{\PYZsh{} create a sorted copy of S}
  \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{temp}\PY{p}{)}\PY{p}{)}\PY{p}{:}
    \PY{k}{if} \PY{n}{temp}\PY{p}{[}\PY{n}{j}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{==} \PY{n}{temp}\PY{p}{[}\PY{n}{j}\PY{p}{]}\PY{p}{:}
      \PY{k}{return} \PY{k+kc}{False}                \PY{c+c1}{\PYZsh{} found duplicate pair}
  \PY{k}{return} \PY{k+kc}{True}                     \PY{c+c1}{\PYZsh{} if we reach this, elements were unique}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n+nb}{print}\PY{p}{(}\PY{n}{unique2}\PY{p}{(}\PY{n}{S1}\PY{p}{)}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{unique2}\PY{p}{(}\PY{n}{S2}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nb}{sorted}\PY{p}{(}\PY{n}{S1}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
