...
\begin{frame}{Four Dimensions of Heterogeneity}
  ...
  \begin{tikzpicture}[
    ...
    \node[quad, fill=PUNavy,        text=white] (A) at (0,   1.7)
          {Structural / Schema\\{\scriptsize\normalfont Different column names\\\& table organisation}};
    \node[quad, fill=PUGold!80!black, text=white] (B) at (5.5, 1.7)
          {Semantic\\{\scriptsize\normalfont Same name,\\ different meaning}};
    \node[quad, fill=PUTeal,         text=white] (C) at (0,  -0.3)
          {Syntactic / Format\\{\scriptsize\normalfont Same data,\\ different encoding}};
    \node[quad, fill=PUOrange,        text=white] (D) at (5.5,-0.3)
          {Scale / Granularity\\{\scriptsize\normalfont Different resolutions,\\ units, cardinalities}};

    % Central label
    \node[font=\bfseries\small, text=PUNavy] at (2.75, 0.7) {Heterogeneity};
  ...
  \begin{columns}[T]
    ...
    \column{0.45\textwidth}
      ...
      \begin{tikzpicture}[
        ...
        % Storage label
        \node[font=\tiny\itshape, text=PUTeal, align=center, text width=2.5cm] at (4.0, 0.35)
