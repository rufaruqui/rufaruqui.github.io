...
\begin{frame}{Three Categories of Digital Data}
  ...
  \begin{tikzpicture}[
    ...
    \node[lbl, below=0.65cm of S]  {of world data};
    \node[lbl, below=0.65cm of SS] {of world data};
    \node[lbl, below=0.65cm of U]  {of world data};
  \end{tikzpicture}
  \end{center}
  \vspace{6pt}
...
\begin{frame}{Extended Framework: The 5Vs of Big Data}
  ...
  \end{tabular}
  \vspace{8pt}
  \begin{alertblock}{Exam-Critical Distinction}
